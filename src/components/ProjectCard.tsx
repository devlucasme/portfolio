...
export const ProjectCard: FC<IProjectCardProps> = ({
    ...
    return (
        <div className="bg-[hsl(240_10%_10%)] border border-gray-700 rounded-lg overflow-hidden transition-all duration-300 hover:border-emerald-400 hover:translate-y-1 hover:shadow-lg flex flex-col h-130">
            {imageUrl ? (
